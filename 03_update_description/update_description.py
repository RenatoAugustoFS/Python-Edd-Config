...
f = open("ip_update_description.txt", "r")
imp = f.readlines()
f.close()
...
while i < quant:
    ...
    try:
        ...
        with open('log_update_description.txt', 'a') as f:
    ...
    """ Instrucoes """
    print("\033[1;92mAguarde um instante... ALTERANDO TODAS AS DESCRICOES\033[0;0m")
    ...
    time.sleep(0.1)
    tn.write(b"description CONEXAO COM EDD\n")
    time.sleep(0.1)
    tn.write(b"interface ethernet 1/5\n")
    time.sleep(0.1)
    tn.write(b"description CONEXAO COM SWITCH OU CPE\n")
    time.sleep(0.1)
    tn.write(b"exit\n")
    time.sleep(0.1)
    tn.write(b"exit\n")
    ...
    """ Guarda o LOG"""
    log = tn.read_all()
    f1 = open("log_update_description.txt", "a")
...
print("verifique o arquivo log_update_description.txt\033[0;0m")
